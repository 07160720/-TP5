<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\wamp\wamp64\www\jd\public/../application/admin\view\cate\upd.html";i:1527909380;s:63:"D:\wamp\wamp64\www\jd\application\admin\view\public\navbar.html";i:1527774212;s:65:"D:\wamp\wamp64\www\jd\application\admin\view\public\slidebar.html";i:1527901516;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
			...
			<i class="icon-double-angle-left" data-icon1="icon-double-angle-left" data-icon2="icon-double-angle-right"></i>
				...
				<div class="main-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo url('cate/updhanddle'); ?>" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="cate_name" name="cate_name" placeholder="请输入分类名称" class="col-xs-10 col-sm-5" style="margin: 10px;" value="<?php echo $cate_find['cate_name']; ?>">
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<input type="submit" name="" value="修改分类" class="btn btn-info">
											&nbsp; &nbsp; &nbsp;
