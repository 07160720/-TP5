<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wamp64\www\jd\public/../application/admin\view\keywords\add.html";i:1528949664;s:58:"D:\wamp64\www\jd\application\admin\view\public\navbar.html";i:1527774212;s:60:"D:\wamp64\www\jd\application\admin\view\public\slidebar.html";i:1528945715;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo url('keywords/addhanddle'); ?>" method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="keywords_name">关键字名称</label>
										<div class="col-sm-9">
											<input type="text" id="keywords_name" name="keywords_name" placeholder="请输入关键字名称" class="col-xs-10 col-sm-5" style="margin: 10px;">
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<input type="submit" name="" value="添加关键字" class="btn btn-info">
											&nbsp; &nbsp; &nbsp;
