<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\wamp\wamp64\www\jd\public/../application/admin\view\index\index.html";i:1527693522;}*/ ?>
﻿
<!DOCTYPE html>
<html lang="en">
	<head>
...
<![endif]-->
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='/jd/public/static/admin/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");
</script>
<![endif]-->
		...
		<!--[if lte IE 8]>
		  <script src="/jd/public/static/admin/assets/js/excanvas.min.js"></script>
		<![endif]-->
